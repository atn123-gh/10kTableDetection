"""
The script is based on "https://github.com/facebookresearch/detectron2/blob/main/detectron2/data/build.py."
Same as original script except make the dataloader generalizable.
...
def build_batch_data_loader(
    ...
    """
    Build a batched dataloader. The main differences from `data_loader_type` are:
